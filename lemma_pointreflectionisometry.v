...
Proof.
	...
	(* assert by cases *)
	assert (Cong A P C Q) as Cong_A_P_C_Q.
	assert (Col A B P \/ ~ Col A B P) as [Col_A_B_P|n_Col_A_B_P] by (apply Classical_Prop.classic).
	{
		(* case Col_A_B_P *)
		...
		destruct Col_A_B_P as [eq_A_B | [eq_A_P | [eq_B_P | [BetS_B_A_P | [BetS_A_B_P | BetS_A_P_B]]]]].
		{
			...
			assert (~ ~ Cong A P C Q) as n_n_Cong_A_P_C_Q.
			{
				intro n_Cong_A_P_C_Q.
				pose proof (lemma_betweennotequal _ _ _ BetS_A_B_C) as (_ & neq_A_B & _).
				contradict eq_A_B.
				exact neq_A_B.
			}
			assert (Cong_A_P_C_Q := n_n_Cong_A_P_C_Q).
			apply Classical_Prop.NNPP in Cong_A_P_C_Q.
		...
		}
		{
			...
			{
				intro n_Cong_A_P_C_Q.
				pose proof (lemma_betweennotequal _ _ _ BetS_P_B_Q) as (_ & neq_P_B & _).
		...
		}
		{
			...
			pose proof (lemma_betweennotequal _ _ _ BetS_P_B_Q) as (neq_B_Q & _ & _).
		...
		}
		{
			...
			assert (~ ~ Cong A P C Q) as n_n_Cong_A_P_C_Q.
			{
				...
				assert (~ BetS B P C) as n_BetS_B_P_C.
				{
					intro BetS_B_P_C.
					...
					pose proof (lemma_congruenceflip _ _ _ _ Cong_P_B_B_Q) as (_ & Cong_B_P_B_Q & _).
					pose proof (cn_sumofparts _ _ _ _ _ _ Cong_A_B_C_B Cong_B_P_B_Q BetS_A_B_P BetS_C_B_Q) as Cong_A_P_C_Q.
					contradict Cong_A_P_C_Q.
					exact n_Cong_A_P_C_Q.
				}


				assert (~ BetS B C P) as n_BetS_B_C_P.
				{
					intro BetS_B_C_P.
		...
		}
		{
			...
			pose proof (lemma_congruenceflip _ _ _ _ Cong_B_Q_P_B) as (_ & _ & Cong_B_Q_B_P).
			pose proof (lemma_doublereverse _ _ _ _ Cong_A_B_B_C) as (Cong_C_B_B_A & _).
			pose proof (lemma_congruenceflip _ _ _ _ Cong_C_B_B_A) as (_ & Cong_B_C_B_A & _).
			...
			pose proof (lemma_betweennotequal _ _ _ BetS_A_B_C) as (neq_B_C & _ & _).
	...
	}
	{
		...
		pose proof (lemma_congruenceflip _ _ _ _ Cong_A_B_B_C) as (_ & Cong_B_A_B_C & _).
		pose proof (lemma_congruenceflip _ _ _ _ Cong_P_B_B_Q) as (_ & Cong_B_P_B_Q & _).
