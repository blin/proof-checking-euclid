...
Proof.
	...
	pose proof (by_prop_BetS_notequal _ _ _ BetS_P_B_Q) as (neq_B_Q & neq_P_B & neq_P_Q).
	pose proof (by_prop_BetS_notequal _ _ _ BetS_Q_B_P) as (neq_B_P & neq_Q_B & neq_Q_P).

	pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_AB_BC) as Cong_BC_AB.
	pose proof (by_prop_Cong_flip _ _ _ _ Cong_AB_BC) as (_ & _ & Cong_AB_CB).
	pose proof (by_prop_Cong_flip _ _ _ _ Cong_BC_AB) as (_ & _ & Cong_BC_BA).
	pose proof (by_prop_Cong_doublereverse _ _ _ _ Cong_BC_AB) as (Cong_BA_CB & _).
	pose proof (by_prop_Cong_doublereverse _ _ _ _ Cong_PB_BQ) as (Cong_QB_BP & _).
	pose proof (by_prop_Cong_flip _ _ _ _ Cong_QB_BP) as (_ & Cong_BQ_BP & _).
	pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_PB_BQ) as Cong_BQ_PB.
	pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_BQ_BP) as Cong_BP_BQ.
	pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_BC_BA) as Cong_BA_BC.
	pose proof (by_prop_Cong_doublereverse _ _ _ _ Cong_BQ_PB) as (Cong_BP_QB & _).
	...
	assert (~ Col A B P \/ ~ ~ Col A B P) as [n_Col_A_B_P|Col_A_B_P] by (apply Classical_Prop.classic).
	{
		...
		pose proof (by_prop_CongA_NC _ _ _ _ _ _ CongA_ABP_QBC) as nCol_Q_B_C.
		pose proof (by_prop_CongA_ABCequalsCBA _ _ _ nCol_Q_B_C) as CongA_QBC_CBQ.

		pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_ABP_QBC CongA_QBC_CBQ) as CongA_ABP_CBQ.
	...
	}
	{
		...
		pose proof (by_prop_OnRay_ABC_ACB _ _ _ OnRay_BC_Q) as OnRay_BQ_C.

		pose proof (by_def_Lt _ _ _ _ _ BetS_B_A_P Cong_BA_CB) as Lt_CB_BP.
		pose proof (by_prop_Lt_congruence _ _ _ _ _ _ Lt_CB_BP Cong_BP_BQ) as Lt_CB_BQ.
		pose proof (by_prop_Lt_congruence_smaller _ _ _ _ _ _ Lt_CB_BQ Cong_CB_BC) as Lt_BC_BQ.
	...
	}
	{
		...
		pose proof (by_prop_Cong_transitive _ _ _ _ _ _ Cong_AB_BP Cong_BP_BQ) as Cong_AB_BQ.
		pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_AB_BQ) as Cong_BQ_AB.
		pose proof (by_prop_Cong_flip _ _ _ _ Cong_BQ_AB) as (_ & _ & Cong_BQ_BA).
	...
	}
	{
		...
		pose proof (by_prop_Lt_congruence _ _ _ _ _ _ Lt_QB_BA Cong_BA_BC) as Lt_QB_BC.
		pose proof (by_prop_Lt_congruence_smaller _ _ _ _ _ _ Lt_QB_BC Cong_QB_BQ) as Lt_BQ_BC.
		...
		pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_BH_BQ) as Cong_BQ_BH.
		...
		pose proof (by_prop_Cong_flip _ _ _ _ Cong_PA_QC) as (Cong_AP_CQ & _ & _).
