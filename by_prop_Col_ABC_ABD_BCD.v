...
Proof.
	...
	destruct Col_A_B_C as [eq_A_C | [eq_B_C | [BetS_B_A_C | [BetS_A_B_C | BetS_A_C_B]]]].
	{
		...
		}
		{
			...
			pose proof (by_def_Col_from_BetS_A_B_C B C D BetS_B_C_D) as Col_B_C_D.
			exact Col_B_C_D.
		}
		{
			(* case BetS_A_B_D *)
			assert (BetS C B D) as BetS_C_B_D by (rewrite <- eq_A_C; exact BetS_A_B_D).
			pose proof (by_def_Col_from_BetS_B_A_C B C D BetS_C_B_D) as Col_B_C_D.
			exact Col_B_C_D.
		}
		{
			(* case BetS_A_D_B *)
			...
			pose proof (by_def_Col_from_BetS_A_C_B B C D BetS_B_D_C) as Col_B_C_D.
			exact Col_B_C_D.
		}
	}
	{
