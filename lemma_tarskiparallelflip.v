...
Proof.
	...
	destruct TP_A_B_C_D as (neq_A_B & neq_C_D & n_Meet_A_B_C_D & SS_C_D_A_B).
	...
	assert (TP A B D C) as TP_A_B_D_C.
	unfold TP.
	split.
	exact neq_A_B.
	split.
	...
	assert (TP B A C D) as TP_B_A_C_D.
	unfold TP.
	split.
	exact neq_B_A.
	split.
	...
	assert (TP B A D C) as TP_B_A_D_C.
	unfold TP.
	split.
	exact neq_B_A.
	split.
