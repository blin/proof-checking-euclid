...
Proof.
	...
	assert (TP_A_B_c_d_2 := TP_A_B_c_d).
	destruct TP_A_B_c_d_2 as (neq_A_B & neq_c_d & n_Meet_A_B_c_d & SS_c_d_A_B).
	...
	{
		(* case eq_c_C *)
		assert (TP A B C d) as TP_A_B_C_d by (rewrite <- eq_c_C; exact TP_A_B_c_d).
	...
	}
	{
		...
		pose proof (lemma_tarski_parallel_collinear_ABcd_Ccd_ABCd _ _ _ _ _ TP_A_B_c_d BetS_C_c_d) as TP_A_B_C_d.
	...
	}
	{
		...
		pose proof (lemma_tarski_parallel_collinear_ABcd_Ccd_ABCd _ _ _ _ _ TP_A_B_d_c BetS_C_d_c) as TP_A_B_C_c.
		pose proof (lemma_tarskiparallelflip _ _ _ _ TP_A_B_C_c) as (_ & TP_A_B_c_C & _).
		pose proof (lemma_tarski_parallel_collinear_ABcd_cCd_ABCd _ _ _ _ _ TP_A_B_c_C BetS_c_d_C) as TP_A_B_d_C.
