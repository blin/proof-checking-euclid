...
Proof.
	...
	pose proof (lemma_s_onray_assert_bets_AEB _ _ _ BetS_G_H_J neq_G_J) as OnRay_GJ_H.
	pose proof (lemma_s_onray_assert_ABB _ _ neq_G_J) as OnRay_GJ_J.

	pose proof (cn_congruencereflexive G H) as Cong_GH_GH.
	pose proof (lemma_s_lt _ _ _ _ _ BetS_G_H_J Cong_GH_GH) as Lt_GH_GJ.
	...
	pose proof (lemma_s_onray_assert_ABB _ _ neq_E_H) as OnRay_EH_H.
	...
	pose proof (lemma_s_onray_assert_ABB _ _ neq_U_b) as OnRay_Ub_b.
	...
	pose proof (lemma_s_onray_assert_bets_AEB _ _ _ BetS_U_W_V neq_U_V) as OnRay_UV_W.
	pose proof (lemma_s_onray_assert_ABB _ _ neq_U_V) as OnRay_UV_V.
	...
	pose proof (lemma_s_onray_assert_ABB _ _ neq_G_E) as OnRay_GE_E.
	...
	pose proof (lemma_s_onray_assert_ABB _ _ neq_b_W) as OnRay_bW_W.
	...
	pose proof (lemma_s_lta _ _ _ _ _ _ _ _ _ BetS_U_W_V OnRay_ba_U OnRay_bc_V CongA_ABC_abW) as LtA_ABC_abc.
