...
Proof.
	...
	assert (~ ~ TarskiPar A B C D) as n_n_TarskiPar_A_B_C_D.
	{
		...
		{
			intro neq_C_d.
			pose proof (lemma_parallelcollinear _ _ _ _ _ TarskiPar_A_B_c_d Col_c_d_C neq_C_d) as TarskiPar_A_B_C_d.
			...
			pose proof (lemma_parallelcollinear _ _ _ _ _ TarskiPar_A_B_d_C Col_d_C_D neq_D_C) as TarskiPar_A_B_D_C.
		...
		pose proof (lemma_parallelcollinear _ _ _ _ _ TarskiPar_A_B_c_C Col_c_C_D neq_D_C) as TarskiPar_A_B_D_C.
		pose proof (lemma_tarskiparallelflip _ _ _ _ TarskiPar_A_B_D_C) as (_ & TarskiPar_A_B_C_D & _).
		contradict TarskiPar_A_B_C_D.
		exact n_TarskiPar_A_B_C_D.
	}
