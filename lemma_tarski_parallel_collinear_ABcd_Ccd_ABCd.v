...
Proof.
	...
	destruct TarskiPar_A_B_c_d as (neq_A_B & _ & n_Meet_A_B_c_d & SS_c_d_A_B).
	...
	assert (~ Col q d C) as n_Col_q_d_C.
	{
		...
		assert (~ neq B p) as n_neq_B_p.
		{
			...
			epose proof (lemma_s_col_ABC_col_ABD_ncol_ACD_eq_AB _ _ _ _ Col_A_r_d Col_A_r_B nCol_A_d_B) as eq_A_r.
			...
			epose proof (lemma_s_col_ABC_col_ABD_ncol_ACD_eq_AB _ _ _ _ Col_A_p_d Col_A_p_B nCol_A_d_B) as eq_A_p.
		...
		epose proof (lemma_s_col_ABC_col_ABD_ncol_ACD_eq_AB _ _ _ _ Col_B_r_d Col_B_r_A nCol_B_d_A) as eq_B_r.
