...
Proof.
    ...
    pose proof (lemma_extension _ _ _ _ neq_C_D neq_C_D) as (E & BetS_C_D_E & Cong_D_E_C_D).
    pose proof (lemma_extension _ _ _ _ neq_B_A neq_B_A) as (F & BetS_B_A_F & Cong_A_F_B_A).

    pose proof (lemma_betweennotequal _ _ _ BetS_C_D_E) as (neq_D_E & _ & neq_C_E).
    pose proof (lemma_inequalitysymmetric _ _ neq_D_E) as neq_E_D.
    pose proof (lemma_inequalitysymmetric _ _ neq_C_E) as neq_E_C.
    pose proof (lemma_betweennotequal _ _ _ BetS_B_A_F) as (neq_A_F & _ & neq_B_F).
    pose proof (lemma_inequalitysymmetric _ _ neq_B_F) as neq_F_B.

    pose proof (axiom_betweennesssymmetry _ _ _ BetS_C_D_E) as BetS_E_D_C.
    pose proof (axiom_betweennesssymmetry _ _ _ BetS_B_A_F) as BetS_F_A_B.


    pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_C_D_E) as Col_C_D_E.
    pose proof (lemma_collinearorder _ _ _ Col_C_D_E) as (Col_D_C_E & Col_D_E_C & Col_E_C_D & Col_C_E_D & Col_E_D_C).
    ...
    epose proof (lemma_collinearparallel _ _ _ _ _ Par_A_B_D_C Col_D_C_E neq_E_C) as Par_A_B_E_C.
    pose proof (lemma_parallelsymmetric _ _ _ _ Par_A_B_E_C) as Par_E_C_A_B.

    epose proof (lemma_collinearparallel _ _ _ _ _ Par_E_C_A_B Col_A_B_F neq_F_B) as Par_E_C_F_B.
    ...
    pose proof (postulate_Euclid2 _ _ neq_A_D) as (G & BetS_A_D_G).
    pose proof (axiom_betweennesssymmetry _ _ _ BetS_A_D_G) as BetS_G_D_A.

    epose proof (proposition_29 _ _ _ _ _ _ _ Par_E_C_F_B BetS_E_D_C BetS_F_A_B BetS_G_D_A).
Qed.
