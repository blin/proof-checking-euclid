...
Proof.
	...
	{
		(* case BetS_B_A_C *)
		pose proof (by_def_Col_from_BetS_A_C_B B C A BetS_B_A_C) as Col_B_C_A.
		exact Col_B_C_A.
	}
	{
		(* case BetS_A_B_C *)
		pose proof (axiom_betweennesssymmetry _ _ _ BetS_A_B_C) as BetS_C_B_A.
		pose proof (by_def_Col_from_BetS_B_A_C B C A BetS_C_B_A) as Col_B_C_A.
		exact Col_B_C_A.
	}
	{
		(* case BetS_A_C_B *)
		pose proof (axiom_betweennesssymmetry _ _ _ BetS_A_C_B) as BetS_B_C_A.
		pose proof (by_def_Col_from_BetS_A_B_C B C A BetS_B_C_A) as Col_B_C_A.
		exact Col_B_C_A.
	}
Qed.
