...
Proof.
	...
	pose proof (postulate_Euclid2 A G neq_A_G) as (b & BetS_A_G_b).
	pose proof (postulate_Euclid2 E H neq_E_H) as (f & BetS_E_H_f).
	pose proof (postulate_Euclid2 C K neq_C_K) as (d & BetS_C_K_d).
	...
	pose proof (lemma_parallel_to_tarski_parallel _ _ _ _ Par_E_H_C_K) as TarskiPar_E_H_C_K.
	destruct TarskiPar_E_H_C_K as (_ & _ & _ & SS_C_K_E_H).
	pose proof (lemma_parallel_to_tarski_parallel _ _ _ _ Par_E_f_C_d) as TarskiPar_E_f_C_d.
	...
	destruct OS_C_E_H_G as (Q & BetS_C_Q_G & Col_E_H_Q & _).
