...
Proof.
	...
	pose proof (by_prop_BetS_notequal _ _ _ BetS_B_C_Q) as (_ & _ & neq_B_Q).
	...
	pose proof (by_prop_nCol_order _ _ _ nCol_B_Q_A) as (_ & _ & _ & nCol_B_A_Q & _).

	pose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_B_A_Q Col_B_A_P neq_B_P) as nCol_B_P_Q.
	pose proof (by_prop_nCol_order _ _ _ nCol_B_P_Q) as (_ & _ & _ & _ & nCol_Q_P_B).
	...
	pose proof (by_prop_Cong_transitive _ _ _ _ _ _ Cong_BU_AP Cong_AP_PA) as Cong_BU_PA.
	pose proof (by_prop_Cong_transitive _ _ _ _ _ _ Cong_BV_CQ Cong_CQ_QC) as Cong_BV_QC.
	pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_BU_PA) as Cong_PA_BU.
	pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_BV_QC) as Cong_QC_BV.
	...
	pose proof (by_prop_Lt_congruence _ _ _ _ _ _ Lt_BU_PB Cong_PB_BP) as Lt_BU_BP.
	pose proof (by_prop_Lt_congruence _ _ _ _ _ _ Lt_BV_QB Cong_QB_BQ) as Lt_BV_BQ.
