...
Proof.
	...
	pose proof (by_prop_Col_order _ _ _ Col_C_D_c) as (Col_D_C_c & _ & _ & _ & _).
	...
	assert (~ Meet B A C D) as n_Meet_B_A_C_D.
	{
		...
		pose proof (by_prop_Col_order _ _ _ Col_B_A_P) as (Col_A_B_P & _ & _ & _ & _).
		pose proof (by_def_Meet _ _ _ _ _ neq_A_B neq_C_D Col_A_B_P Col_C_D_P) as Meet_A_B_C_D.
