...
Proof.
	...
	pose proof (by_def_Col_from_BetS_A_B_C _ _ _ BetS_H_B_K) as Col_H_B_K.

	pose proof (by_prop_Par_NC _ _ _ _ Par_MB_HL) as (nCol_M_B_H & nCol_M_H_L & nCol_B_H_L & nCol_M_B_L).

	assert (Par_MB_HL_2 := Par_MB_HL).
	destruct Par_MB_HL_2 as (_ & _ & _ & _ & _ & neq_M_B & neq_H_L & _ & _ & _ & _ & _ & _ & n_Meet_M_B_H_L & _ & _).
	...
	}
	{
		...
		pose proof (by_def_Col_from_BetS_A_B_C _ _ _ BetS_M_E_B) as Col_M_E_B.
	...
	}
	{
		...
		pose proof (by_def_Col_from_BetS_A_B_C _ _ _ BetS_H_E_L) as Col_H_E_L.
		pose proof (by_def_Col_from_BetS_A_B_C _ _ _ BetS_M_B_E) as Col_M_B_E.
		pose proof (by_prop_Col_order _ _ _ Col_H_E_L) as (_ & _ & _ & Col_H_L_E & _).
