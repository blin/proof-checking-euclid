...
Lemma lemma_oppositeside_betweenness_PABC_RQP_QABC :
	forall A B C P Q R,
...
Proof.
	...
	pose proof (lemma_s_ncol_n_col _ _ _ nCol_C_P_R) as n_Col_C_P_R.
	pose proof (lemma_collinearorder _ _ _ Col_A_B_S) as (Col_B_A_S & Col_B_S_A & Col_S_A_B & Col_A_S_B & Col_S_B_A). (* wanted Col_R_S_B *)
	pose proof (lemma_collinearorder _ _ _ Col_A_B_R) as (Col_B_A_R & Col_B_R_A & Col_R_A_B & Col_A_R_B & Col_R_B_A). (* wanted Col_R_S_B *)
	...
	pose proof (lemma_collinearorder _ _ _ Col_B_R_S) as (Col_R_B_S & Col_R_S_B & Col_S_B_R & Col_B_S_R & Col_S_R_B). (* wanted Col_R_S_B *)
	pose proof (lemma_betweennotequal _ _ _ BetS_R_F_S) as (neq_F_S & neq_R_F & neq_R_S). (* wanted neq_R_S *)
	pose proof (lemma_collinear_ABC_ABD_BCD _ _ _ _ Col_R_S_F Col_R_S_B neq_R_S) as Col_S_F_B.
	pose proof (lemma_collinearorder _ _ _ Col_S_F_B) as (Col_F_S_B & Col_F_B_S & Col_B_S_F & Col_S_B_F & Col_B_F_S). (* wanted Col_S_B_F *)
	...
	assert (~ Col A B Q) as n_Col_A_B_Q.
	{
		...
		pose proof (lemma_collinearorder _ _ _ Col_R_Q_P) as (Col_Q_R_P & Col_Q_P_R & Col_P_R_Q & Col_R_P_Q & Col_P_Q_R). (* wanted Col_Q_R_P *)
		...
		pose proof (lemma_collinearorder _ _ _ Col_R_C_P) as (Col_C_R_P & Col_C_P_R & Col_P_R_C & Col_R_P_C & Col_P_C_R). (* wanted Col_C_P_R *)
