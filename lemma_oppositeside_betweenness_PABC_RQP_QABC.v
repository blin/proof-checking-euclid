...
Proof.
	...
	pose proof (by_def_n_Col_from_nCol _ _ _ nCol_C_P_R) as n_Col_C_P_R.
	pose proof (by_prop_Col_order _ _ _ Col_A_B_S) as (Col_B_A_S & Col_B_S_A & Col_S_A_B & Col_A_S_B & Col_S_B_A). (* wanted Col_R_S_B *)
	pose proof (by_prop_Col_order _ _ _ Col_A_B_R) as (Col_B_A_R & Col_B_R_A & Col_R_A_B & Col_A_R_B & Col_R_B_A). (* wanted Col_R_S_B *)
	...
	pose proof (by_prop_BetS_notequal _ _ _ BetS_R_F_S) as (neq_F_S & neq_R_F & neq_R_S). (* wanted neq_R_S *)
	pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_R_S_F Col_R_S_B neq_R_S) as Col_S_F_B.
	pose proof (by_prop_Col_order _ _ _ Col_S_F_B) as (Col_F_S_B & Col_F_B_S & Col_B_S_F & Col_S_B_F & Col_B_F_S). (* wanted Col_S_B_F *)
	...
	assert (~ Col A B Q) as n_Col_A_B_Q.
	{
		...
		pose proof (by_prop_Col_order _ _ _ Col_R_C_P) as (Col_C_R_P & Col_C_P_R & Col_P_R_C & Col_R_P_C & Col_P_C_R). (* wanted Col_C_P_R *)
