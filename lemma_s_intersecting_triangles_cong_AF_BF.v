...
Proof.
	...
	pose proof (by_prop_nCol_order _ _ _ nCol_A_B_D) as (_ & _ & _ & nCol_A_D_B & _).
	pose proof (by_prop_nCol_order _ _ _ nCol_B_D_E) as (_ & nCol_D_E_B & _ & _ & _).
	...
	pose proof (
		by_prop_Lt_congruence _ _ _ _ _ _ Lt_BF_BE Cong_BE_AD
	) as (G & BetS_A_G_D & Cong_AG_BF).

	pose proof (
		lemma_differenceofparts _ _ _ _ _ _ Cong_AG_BF Cong_AD_BE BetS_A_G_D BetS_B_F_E
	) as Cong_GD_FE.
	pose proof (by_prop_Cong_doublereverse _ _ _ _ Cong_GD_FE) as (Cong_EF_DG & _).
	pose proof (by_prop_Cong_doublereverse _ _ _ _ Cong_AG_BF) as (Cong_FB_GA & _).
	pose proof (by_prop_Cong_flip _ _ _ _ Cong_AE_BD) as (Cong_EA_DB & _ & _).
	...
	pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_AG_BF) as Cong_BF_AG.
	pose proof (by_prop_Cong_doublereverse _ _ _ _ Cong_EF_DG) as (_ & Cong_FE_GD).
	pose proof (
		lemma_interior5
		B F E D
		A G D E
