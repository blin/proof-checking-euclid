...
Proof.
	...
	pose proof (lemma_congruencesymmetric _ _ _ _ Cong_AB_DE) as Cong_DE_AB.
	pose proof (lemma_congruencesymmetric _ _ _ _ Cong_AC_DF) as Cong_DF_AC.
	...
	assert (~ CongA E D F B A C) as n_CongA_EDF_BAC.
	{
		...
		pose proof (lemma_equalanglessymmetric _ _ _ _ _ _ CongA_EDF_BAC) as CongA_BAC_EDF.
		...
		pose proof (lemma_lessthancongruence_smaller _ _ _ _ _ _ Lt_EF_BC Cong_EF_BC) as Lt_BC_BC.
