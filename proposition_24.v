...
Proof.
	...
	pose proof (lemma_layoff _ _ _ _ neq_A_T neq_A_C) as (H & OnRay_A_T_H & Cong_A_H_A_C).
	...
	epose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_A_T_B Col_A_T_H neq_A_H) as nCol_A_H_B.
	pose proof (lemma_NCdistinct _ _ _ nCol_A_H_B) as (_ & neq_H_B & _ & _ & neq_B_H & _).
	pose proof (lemma_NCorder _ _ _ nCol_A_H_B) as (nCol_H_A_B & nCol_H_B_A & nCol_B_A_H & nCol_A_B_H & nCol_B_H_A).

	epose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_A_C_B Col_A_C_Q neq_A_Q) as nCol_A_Q_B.
	pose proof (lemma_NCdistinct _ _ _ nCol_A_Q_B) as (_ & neq_Q_B & _ & _ & neq_B_Q & _).
	pose proof (lemma_NCorder _ _ _ nCol_A_Q_B) as (nCol_Q_A_B & nCol_Q_B_A & nCol_B_A_Q & nCol_A_B_Q & nCol_B_Q_A).

	epose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_A_B_Q Col_A_B_P neq_A_P) as nCol_A_P_Q.
	pose proof (lemma_NCdistinct _ _ _ nCol_A_P_Q) as (_ & neq_P_Q & _ & _ & neq_Q_P & _).
	...
	epose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_A_H_B Col_A_H_J neq_A_J) as nCol_A_J_B.
	pose proof (lemma_NCorder _ _ _ nCol_A_J_B) as (nCol_J_A_B & nCol_J_B_A & nCol_B_A_J & nCol_A_B_J & nCol_B_J_A).

	epose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_J_B_A Col_J_B_C neq_J_C) as nCol_J_C_A.
	pose proof (lemma_NCorder _ _ _ nCol_J_C_A) as (nCol_C_J_A & nCol_C_A_J & nCol_A_J_C & nCol_J_A_C & nCol_A_C_J).

	epose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_A_J_C Col_A_J_H neq_A_H) as nCol_A_H_C.
	...
	pose proof (lemma_onray_orderofpoints_any _ _ _ OnRay_A_J_H) as [BetS_A_H_J | [eq_J_H | BetS_A_J_H]].
	{
		...
		pose proof (lemma_NCdistinct _ _ _ nCol_C_J_H) as (_ & neq_J_H & _ & _ & neq_H_J & _).
...
pose proof (lemma_s_onray_assert_bets_AEB H A J BetS_H_J_A neq_H_A) as OnRay_H_A_J.
	...
	epose proof (proposition_04 A H B D F E Cong_A_H_D_F Cong_A_B_D_E CongA_H_A_B_F_D_E) as (Cong_H_B_F_E & _ & _).
