...
Proof.
	...
	pose proof (lemma_samesidesymmetric _ _ _ _ SameSide_M_P_AB) as (SameSide_P_M_AB & _ & _).
	...
	pose proof (lemma_right_triangle_NC _ _ _ RightTriangle_EQM) as nCol_E_Q_M.
	...
	assert (~ eq C Q) as n_eq_C_Q.
	{
		...
		pose proof (lemma_collinearright _ _ _ _ RightTriangle_ECM Col_E_C_A neq_A_C) as RightTriangle_ACM.
	...
	pose proof (lemma_collinearright _ _ _ _ RightTriangle_EQM Col_E_Q_C neq_C_Q) as RightTriangle_CQM.
	pose proof (lemma_right_triangle_NC _ _ _ RightTriangle_CQM) as nCol_C_Q_M.
	...
	pose proof (lemma_congruencesymmetric _ _ _ _ Cong_QJ_MQ) as Cong_MQ_QJ.
	pose proof (lemma_congruenceflip _ _ _ _ Cong_QJ_MQ) as (_ & Cong_JQ_MQ & _).
	...
	pose proof (lemma_congruencesymmetric _ _ _ _ Cong_MQ_HC) as Cong_HC_MQ.
	pose proof (lemma_congruenceflip _ _ _ _ Cong_MG_JG) as (_ & Cong_GM_JG & _).
	pose proof (lemma_congruencetransitive _ _ _ _ _ _ Cong_HG_GM Cong_GM_JG) as Cong_HG_JG.
	pose proof (lemma_congruencetransitive _ _ _ _ _ _ Cong_HG_JG Cong_JG_GK) as Cong_HG_GK.
	pose proof (lemma_congruenceflip _ _ _ _ Cong_HG_GK) as (_ & _ & Cong_HG_KG).
	pose proof (lemma_congruencetransitive _ _ _ _ _ _ Cong_HC_MQ Cong_MQ_QJ) as Cong_HC_QJ.
	pose proof (lemma_congruencetransitive _ _ _ _ _ _ Cong_HC_QJ Cong_QJ_CK) as Cong_HC_CK.
	pose proof (lemma_congruenceflip _ _ _ _ Cong_HC_CK) as (_ & _ & Cong_HC_KC).
