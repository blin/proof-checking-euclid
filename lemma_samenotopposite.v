...
Proof.
	...
	pose proof (lemma_samesidesymmetric _ _ _ _ SS_A_B_CD) as (SS_B_A_CD & _ & _).

	assert (~ OS A C D B) as n_OS_A_CD_B.
	{
		intro OS_A_CD_B.
		pose proof (lemma_planeseparation _ _ _ _ _ SS_B_A_CD OS_A_CD_B) as OS_B_CD_B.

		destruct OS_B_CD_B as (M & BetS_B_M_B & _).
