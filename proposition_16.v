...
Proof.
	...
	pose proof (lemma_collinearorder _ _ _ Col_B_e_C) as (_ & _ & _ & Col_B_C_e & _).
	...
	pose proof (lemma_NCorder _ _ _ nCol_B_e_A) as (_ & _ & nCol_A_B_e & _ & nCol_A_e_B).
	...
	pose proof (lemma_equalanglesNC _ _ _ _ _ _ CongA_ABC_eCf) as nCol_e_C_f.
	...
	pose proof (lemma_extension _ _ _ _ neq_A_C neq_E_C) as (G & BetS_A_C_G & _).
