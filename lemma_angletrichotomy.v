...
Proof.
	...
	assert (~ LtA D E F A B C) as n_LtA_DEF_ABC.
	{
		...
		pose proof (by_prop_LtA_transitive _ _ _ _ _ _ _ _ _ LtA_ABC_DEF LtA_DEF_ABC) as LtA_ABC_ABC.
		...
		pose proof (by_prop_BetS_notequal _ _ _ BetS_G_H_J) as (_ & neq_G_H & _).
		pose proof (by_prop_BetS_notequal _ _ _ BetS_J_H_G) as (_ & neq_J_H & _).
		...
		pose proof (by_prop_OnRay_impliescollinear _ _ _ OnRay_BA_G) as Col_B_A_G.
		pose proof (by_prop_Col_order _ _ _ Col_B_A_G) as (Col_A_B_G & _ & Col_G_B_A  & Col_B_G_A  & _).

		pose proof (by_prop_OnRay_neq_A_C _ _ _ OnRay_BC_J) as neq_B_J.
		pose proof (by_prop_neq_symmetric _ _ neq_B_J) as neq_J_B.
		pose proof (by_prop_OnRay_impliescollinear _ _ _ OnRay_BC_J) as Col_B_C_J.
		pose proof (by_prop_Col_order _ _ _ Col_B_C_J) as (_ & _ & Col_J_B_C & Col_B_J_C  & _).
		...
		pose proof (by_prop_Col_order _ _ _ Col_B_A_U) as (_ & _ & Col_U_B_A & _ & _).
		pose proof (by_prop_OnRay_neq_A_C _ _ _ OnRay_BA_U) as neq_B_U.
		pose proof (by_prop_neq_symmetric _ _ neq_B_U) as neq_U_B.
		pose proof (by_prop_OnRay_shared_initial_point _ _ _ _ OnRay_BA_G OnRay_BA_U) as OnRay_BG_U.
		pose proof (by_prop_OnRay_impliescollinear _ _ _ OnRay_BG_U) as Col_B_G_U.
		pose proof (by_prop_Col_order _ _ _ Col_B_G_U) as (_ & _ & _ & Col_B_U_G & _).
		...
		pose proof (by_prop_OnRay_shared_initial_point _ _ _ _ OnRay_BC_J OnRay_BC_V) as OnRay_BJ_V.
		pose proof (by_prop_OnRay_impliescollinear _ _ _ OnRay_BJ_V) as Col_B_J_V.
		pose proof (by_prop_Col_order _ _ _ Col_B_J_V) as (_ & _ & Col_V_B_J & _ & _).
		...
		assert (~ Col B U H) as n_Col_B_U_H.
		{
			...
			pose proof (by_prop_Col_order _ _ _ Col_B_U_H) as (Col_U_B_H & _ & _ & _ & _).

			pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_U_B_A Col_U_B_H neq_U_B) as Col_B_A_H.
			pose proof (by_prop_Col_order _ _ _ Col_B_A_H) as (Col_A_B_H & _ & Col_H_B_A & _ & _).

			pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_A_B_G Col_A_B_H neq_A_B) as Col_B_G_H.
			pose proof (by_prop_Col_order _ _ _ Col_B_G_H) as (_ & Col_G_H_B & _ & _ & _).

			pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_G_H_B Col_G_H_J neq_G_H) as Col_H_B_J.

			assert (~ neq H B) as eq_H_B.
			{
				intros neq_H_B.

				pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_H_B_J Col_H_B_A neq_H_B) as Col_B_J_A.
				pose proof (by_prop_Col_order _ _ _ Col_B_J_A) as (_ & _ & _ & Col_B_A_J & _).
			...
			pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_G_J_A Col_G_J_B neq_G_J) as Col_J_A_B.
			pose proof (by_prop_Col_order _ _ _ Col_J_A_B) as (_ & _ & _ & _ & Col_B_A_J).
		...
		pose proof (by_prop_nCol_order _ _ _ nCol_B_U_C) as (_ & _ & _ & nCol_B_C_U & _).
		pose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_B_C_U Col_B_C_J neq_B_J) as nCol_B_J_U.
		pose proof (by_prop_nCol_order _ _ _ nCol_B_J_U) as (_ & _ & _ & nCol_B_U_J & _).
		...
		pose proof (by_prop_OnRay_neq_A_C _ _ _ OnRay_BH_V) as neq_B_V.
		pose proof (by_prop_neq_symmetric _ _ neq_B_V) as neq_V_B.
		pose proof (by_prop_OnRay_impliescollinear _ _ _ OnRay_BH_V) as Col_B_H_V.
		pose proof (by_prop_Col_order _ _ _ Col_B_H_V) as (_ & _ & Col_V_B_H & _ & _).

		pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_V_B_J Col_V_B_H neq_V_B) as Col_B_J_H.
		pose proof (by_prop_Col_order _ _ _ Col_B_J_H) as (_ & _ & _ & _ & Col_H_J_B).
		pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_H_J_B Col_H_J_G neq_H_J) as Col_J_B_G.
		pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_J_B_G Col_J_B_C neq_J_B) as Col_B_G_C.
		pose proof (by_prop_Col_order _ _ _ Col_B_G_C) as (Col_G_B_C & _ & _ & _ & _).
		pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_G_B_C Col_G_B_A neq_G_B) as Col_B_C_A.
