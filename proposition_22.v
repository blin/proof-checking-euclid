...
Proof.
	...
	intros BetS_D_F_G.
	intros Cong_P_Q_C_c.
	epose proof (lemma_together _ _ _ _ _ _ _ _ _ _ _ TogetherGreater_A_a_B_b_C_c Cong_D_F_A_a Cong_F_G_B_b BetS_D_F_G Cong_P_Q_C_c) as (Lt_P_Q_D_G & _).
	exact Lt_P_Q_D_G.
Qed.
...
Proof.
	...
	pose proof (lemma_betweennotequal _ _ _ BetS_A_a_P) as (_ & neq_A_a & _).
	pose proof (lemma_betweennotequal _ _ _ BetS_A_a_P) as (neq_a_P & _ & _).
	pose proof (axiom_nocollapse _ _ _ _ neq_a_P Cong_a_P_B_b) as neq_B_b.
	pose proof (lemma_lessthannotequal _ _ _ _ Lt_C_c_A_P) as (neq_C_c & _). (* forward_using *)
	pose proof (lemma_layoff _ _ _ _ neq_F_E neq_B_b (* not real *)) as (G & OnRay_F_E_G & Cong_F_G_B_b).
	...
	pose proof (lemma_togethera _ _ _ _ _ _ _ _ _ _ _ TogetherGreater_A_a_B_b_C_c Cong_D_F_A_a Cong_F_G_B_b BetS_D_F_G Cong_C_c_C_c) as Lt_C_c_D_G.
...
assert (BetS F G J) as BetS_F_G_J by (rewrite eq_G_Q; exact BetS_F_Q_J).
	...
	assert (~ Col F G K) as n_Col_F_G_K.
	{
		...
		}
		{
			...
			{
				intro Col_F_G_K.
				pose proof (lemma_trichotomy_asymmetric _ _ _ _ Lt_G_K_G_K (* not real *)) as n_Lt_G_K_G_K.
		...
		}
		{
			...
			{
				intro Col_F_G_K.
				pose proof (lemma_trichotomy_asymmetric _ _ _ _ Lt_F_K_F_K (* not real *)) as n_Lt_F_K_F_K.
		...
		}
		{
			...
			{
				intro Col_F_G_K.
				pose proof (lemma_trichotomy_asymmetric _ _ _ _ Lt_F_G_F_G (* not real *)) as n_Lt_F_G_F_G.
