...
Proof.
	...
	pose proof (lemma_onray_impliescollinear _ _ _ OnRay_RQ_P) as Col_R_Q_P.
	...
	assert (Col C P R \/ ~ Col C P R) as [Col_C_P_R|n_Col_C_P_R] by (apply Classical_Prop.classic).
	{
		...
		pose proof (lemma_onray_orderofpoints_any _ _ _ OnRay_RQ_P) as [BetS_R_P_Q | [eq_Q_P | BetS_R_Q_P]].
		{
			(* case BetS_R_P_Q *)
