...
Proof.
    ...
    epose proof (proposition_29 A E B H _ D C Par_A_E_B_H BetS_A_D_E BetS_B_C_H BetS_F_D_C OS_A_D_C_H) as (CongA_A_D_C_D_C_H & _ & _).
    epose proof (proposition_29 _ _ _ _ _ _ _ Par_F_C_G_B BetS_F_D_C BetS_G_A_B BetS_E_D_A OS_F_D_A_B) as (_ & _ & SumTwoRT_C_D_A_D_A_B).
    ...
    pose proof (lemma_supplementofright _ _ _ _ _ Supp_XYU_VYZ RightTriangle_X_Y_U) as (_ & RightTriangle_V_Y_Z).
