...
Proof.
	...
	pose proof (lemma_parallel_to_tarski_parallel _ _ _ _ Par_C_D_A_B) as TP_C_D_A_B.
	destruct TP_C_D_A_B as (_ & _ & _ & SS_A_B_CD).

	pose proof (lemma_parallel_to_tarski_parallel _ _ _ _ Par_A_D_B_C) as TP_A_D_B_C.
