...
Proof.
	...
	pose proof (lemma_twoperpsparallel _ _ _ _ RightTriangle_ABC RightTriangle_BCD SS_A_D_BC) as Par_AB_CD.
	...
	pose proof (proposition_33B _ _ _ _ Par_AB_DC Cong_AB_DC SS_A_D_BC) as (Par_AD_BC & Cong_AD_BC).
	...
	destruct TarskiPar_CD_AB as (_ & _ & _ & SS_A_B_CD).

	pose proof (lemma_parallel_to_tarski_parallel _ _ _ _ Par_AD_BC) as TarskiPar_AD_BC.
	destruct TarskiPar_AD_BC as (_ & _ & _ & SS_B_C_AD).
	...
	pose proof (proposition_29 _ _ _ _ _ _ _ Par_AE_BH BetS_A_D_E BetS_B_C_H BetS_F_D_C OS_A_DC_H) as (CongA_ADC_DCH & _ & _).
	pose proof (proposition_29 _ _ _ _ _ _ _ Par_FC_GB BetS_F_D_C BetS_G_A_B BetS_E_D_A OS_F_DA_B) as (_ & _ & SumTwoRT_CDA_DAB).
