...
Proof.
	...
	pose proof (by_prop_OnRay_impliescollinear _ _ _ OnRay_AB_G) as Col_A_B_G.
	pose proof (by_prop_Col_order _ _ _ Col_A_B_G) as (Col_B_A_G & Col_B_G_A & Col_G_A_B & Col_A_G_B & Col_G_B_A).

	pose proof (by_prop_CongA_symmetric _ _ _ _ _ _ CongA_FAG_DCE) as CongA_DCE_FAG.
	...
	pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_A_B_J Col_A_B_H neq_A_B) as Col_B_J_H.
	pose proof (by_prop_Col_order _ _ _ Col_B_J_H) as (Col_J_B_H & Col_J_H_B & Col_H_B_J & Col_B_H_J & Col_H_J_B).
	...
	pose proof (by_prop_BetS_notequal _ _ _ BetS_J_H_T) as (_ & _ & neq_J_T).
	pose proof (by_def_Col_from_BetS_A_B_C _ _ _ BetS_J_H_T) as Col_J_H_T.
	pose proof (by_prop_Col_order _ _ _ Col_J_H_T) as (Col_H_J_T & Col_H_T_J & Col_T_J_H & Col_J_T_H & Col_T_H_J).


	pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_H_J_B Col_H_J_T neq_H_J) as Col_J_B_T.
	pose proof (by_prop_Col_order _ _ _ Col_J_B_T) as (Col_B_J_T & Col_B_T_J & Col_T_J_B & Col_J_T_B & Col_T_B_J).
	pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_B_A_J Col_B_A_H neq_B_A) as Col_A_J_H.
	pose proof (by_prop_Col_order _ _ _ Col_A_J_H) as (Col_J_A_H & Col_J_H_A & Col_H_A_J & Col_A_H_J & Col_H_J_A).
	pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_H_J_A Col_H_J_T neq_H_J) as Col_J_A_T.
	pose proof (by_prop_Col_order _ _ _ Col_J_A_T) as (Col_A_J_T & Col_A_T_J & Col_T_J_A & Col_J_T_A & Col_T_A_J).
	pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_J_T_A Col_J_T_B neq_J_T) as Col_T_A_B.
	pose proof (by_prop_Col_order _ _ _ Col_T_A_B) as (Col_A_T_B & Col_A_B_T & Col_B_T_A & Col_T_B_A & Col_B_A_T).

	assert (~ Col J T P) as n_Col_J_T_P.
	{
		intro Col_J_T_P.

		pose proof (by_prop_Col_ABC_ABD_ABE_CDE _ _ _ _ _ neq_J_T Col_J_T_A Col_J_T_B Col_J_T_P) as Col_A_B_P.
	...
	pose proof (by_prop_RightTriangle_NC _ _ _ RightTriangle_JHQ) as nCol_J_H_Q.
	pose proof (by_prop_nCol_distinct _ _ _ nCol_J_H_Q) as (_ & neq_H_Q & neq_J_Q & _ & neq_Q_H & neq_Q_J).
	pose proof (by_prop_nCol_order _ _ _ nCol_J_H_Q) as (nCol_H_J_Q & nCol_H_Q_J & nCol_Q_J_H & nCol_J_Q_H & nCol_Q_H_J).

	pose proof (lemma_layoff _ _ _ _ neq_H_Q neq_H_F) as (S & OnRay_HQ_S & Cong_HS_HF).

	pose proof (by_prop_OnRay_ABC_ACB _ _ _ OnRay_HQ_S) as OnRay_HS_Q.

	pose proof (by_prop_Cong_doublereverse _ _ _ _ Cong_HS_HF) as (Cong_FH_SH & _).
	pose proof (by_prop_Cong_flip _ _ _ _ Cong_FH_SH) as (Cong_HF_HS & _ & _).

	pose proof (by_prop_RightTriangle_leg_change _ _ _ _ RightTriangle_JHQ OnRay_HQ_S) as RightTriangle_JHS.
	...
	assert (eq A H \/ neq A H) as [eq_A_H|neq_A_H] by (apply Classical_Prop.classic).
	{
		...
		pose proof (by_prop_RightTriangle_collinear _ _ _ _ RightTriangle_JAF Col_J_A_G neq_G_A) as RightTriangle_GAF.
		pose proof (by_prop_RightTriangle_symmetric _ _ _ RightTriangle_GAF) as RightTriangle_FAG.
		pose proof (by_prop_RightTriangle_collinear _ _ _ _ RightTriangle_JAS Col_J_A_G neq_G_A) as RightTriangle_GAS.
		pose proof (by_prop_RightTriangle_symmetric _ _ _ RightTriangle_GAS) as RightTriangle_SAG.
	...
	}
	{
		...
		pose proof (by_prop_RightTriangle_collinear _ _ _ _ RightTriangle_JHF Col_J_H_A neq_A_H) as RightTriangle_AHF.
		pose proof (by_prop_RightTriangle_collinear _ _ _ _ RightTriangle_JHS Col_J_H_A neq_A_H) as RightTriangle_AHS.
		pose proof (by_prop_RightTriangle_symmetric _ _ _ RightTriangle_AHF) as RightTriangle_FHA.

		pose proof (by_prop_RightTriangle_NC _ _ _ RightTriangle_FHA) as nCol_F_H_A.
		pose proof (by_prop_RightTriangle_NC _ _ _ RightTriangle_AHS) as nCol_A_H_S.

		pose proof (by_prop_nCol_order _ _ _ nCol_F_H_A) as (nCol_H_F_A & nCol_H_A_F & nCol_A_F_H & nCol_F_A_H & nCol_A_H_F).

		pose proof (by_prop_nCol_distinct _ _ _ nCol_A_H_S) as (_ & neq_H_S & neq_A_S & _ & neq_S_H & neq_S_A).
		pose proof (by_prop_nCol_order _ _ _ nCol_A_H_S) as (nCol_H_A_S & nCol_H_S_A & nCol_S_A_H & nCol_A_S_H & nCol_S_H_A).

		pose proof (by_def_OnRay_from_neq_A_B _ _ neq_A_S) as OnRay_AS_S.

		pose proof (by_prop_CongA_ABCequalsCBA _ _ _ nCol_A_H_S) as CongA_AHS_SHA.
		pose proof (by_prop_CongA_ABCequalsCBA _ _ _ nCol_F_A_H) as CongA_FAH_HAF.
		pose proof (by_prop_CongA_ABCequalsCBA _ _ _ nCol_F_H_A) as CongA_FHA_AHF.
		pose proof (by_prop_CongA_ABCequalsCBA _ _ _ nCol_H_A_S) as CongA_HAS_SAH.

		pose proof (by_prop_CongA_reflexive _ _ _ nCol_F_A_H) as CongA_FAH_FAH.
		pose proof (by_prop_CongA_reflexive _ _ _ nCol_S_A_H) as CongA_SAH_SAH.

		pose proof (lemma_Euclid4 _ _ _ _ _ _ RightTriangle_AHF RightTriangle_AHS) as CongA_AHF_AHS.
		pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_FHA_AHF CongA_AHF_AHS) as CongA_FHA_AHS.
		pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_FHA_AHS CongA_AHS_SHA) as CongA_FHA_SHA.
		pose proof (proposition_04 _ _ _ _ _ _ Cong_HF_HS Cong_HA_HA CongA_FHA_SHA) as (_ & _ & CongA_HAF_HAS).
		pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_FAH_HAF CongA_HAF_HAS) as CongA_FAH_HAS.
		pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_FAH_HAS CongA_HAS_SAH) as CongA_FAH_SAH.
		...
		{
			(* case eq_G_H *)
			pose proof (by_def_Col_from_eq_A_B G H A eq_G_H) as Col_G_H_A.

			exact Col_G_H_A.
		}
		{
			(* case neq_G_H *)
			pose proof (by_prop_Col_ABC_ABD_ABE_CDE _ _ _ _ _ neq_A_B Col_A_B_G Col_A_B_H Col_A_B_A) as Col_G_H_A.
		...
		}
		{
			...
			pose proof (by_def_OnRay_from_BetS_A_E_B _ _ _ BetS_A_G_H neq_A_H) as OnRay_AH_G.

			pose proof (by_prop_CongA_helper _ _ _ _ _ _ _ _ CongA_FAH_FAH OnRay_AF_F OnRay_AH_G) as CongA_FAH_FAG.
			pose proof (by_prop_CongA_helper _ _ _ _ _ _ _ _ CongA_SAH_SAH OnRay_AS_S OnRay_AH_G) as CongA_SAH_SAG.
			pose proof (by_prop_CongA_symmetric _ _ _ _ _ _ CongA_FAH_FAG) as CongA_FAG_FAH.
			pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_FAG_FAH CongA_FAH_SAH) as CongA_FAG_SAH.
			pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_FAG_SAH CongA_SAH_SAG) as CongA_FAG_SAG.
		...
		}
		{
			...
			pose proof (by_def_OnRay_from_BetS_A_B_E _ _ _ BetS_A_H_G neq_A_H) as OnRay_AH_G.
	...
	pose proof (by_prop_CongA_symmetric _ _ _ _ _ _ CongA_FAG_SAG) as CongA_SAG_FAG.
	pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_SAG_FAG CongA_FAG_DCE) as CongA_SAG_DCE.
	...
	assert (~ Col A B S) as n_Col_A_B_S.
	{
		...
		pose proof (by_prop_Col_ABC_ABD_ABE_CDE _ _ _ _ _ neq_A_B Col_A_B_J Col_A_B_T Col_A_B_S) as Col_J_T_S.
