...
Proof.
	...
	destruct Lt_A_B_A_C as (M & BetS_A_M_C & Cong_A_M_A_B).
	pose proof (lemma_betweennotequal _ _ _ BetS_A_M_C) as (_ & neq_A_M & _).
	pose proof (lemma_s_onray_assert_bets_ABE A M C BetS_A_M_C neq_A_M) as OnRay_A_M_C.
	pose proof (lemma_onray_ABC_ACB _ _ _ OnRay_A_M_C) as OnRay_A_C_M.
	pose proof (lemma_onray_ABC_ACB _ _ _ OnRay_A_B_C) as OnRay_A_C_B.
	pose proof (lemma_layoffunique _ _ _ _ OnRay_A_C_M OnRay_A_C_B Cong_A_M_A_B) as eq_M_B.
