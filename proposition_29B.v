...
Proof.
	...
	pose proof (lemma_parallelNC _ _ _ _ Par_A_G_H_D) as (nCol_A_G_H & _).
	pose proof (lemma_NCdistinct _ _ _ nCol_A_G_H) as (neq_A_G & neq_G_H & neq_A_H & neq_G_A & neq_H_G & neq_H_A).

	destruct Par_A_G_H_D as (a & g & h & d & m & _ & neq_H_D & Col_A_G_a & Col_A_G_g & neq_a_g & Col_H_D_h & Col_H_D_d & neq_h_d & n_Meet_A_G_H_D & BetS_a_m_d & BetS_h_m_g).
	...
	pose proof (postulate_Euclid2 D H neq_D_H) as (C & BetS_D_H_C).
	pose proof (postulate_Euclid2 H G neq_H_G) as (E & BetS_H_G_E).
