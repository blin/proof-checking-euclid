...
Proof.
	...
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_B_A_F) as Col_B_A_F.
	...
	pose proof (lemma_s_col_BetS_B_A_C _ _ _ BetS_E_C_H) as Col_C_E_H.

	pose proof (lemma_equalanglesflip _ _ _ _ _ _ CongA_ECA_CAB) as CongA_ACE_BAC.
	pose proof (lemma_equalanglessymmetric _ _ _ _ _ _ CongA_ACE_BAC) as CongA_BAC_ACE.

	pose proof (lemma_collinearparallel _ _ _ _ _ Par_EH_FB Col_F_B_A neq_A_B) as Par_EH_AB.
	...
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_E_S_B) as Col_E_S_B.
	...
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_C_S_A) as Col_C_S_A.
	...
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_A_B_M) as Col_A_B_M.
	...
	pose proof (lemma_collinearparallel _ _ _ _ _ Par_EH_BA Col_B_A_M neq_M_A) as Par_EH_MA.
	pose proof (lemma_parallelflip _ _ _ _ Par_EH_MA) as (Par_HE_MA & _ & _).
	...
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_L_E_H) as Col_L_E_H.
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_H_E_L) as Col_H_E_L.
	...
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_A_Q_H) as Col_A_Q_H.
	...
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_E_S_Q) as Col_E_S_Q.
	...
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_B_T_C) as Col_B_T_C.
	...
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_A_T_H) as Col_A_T_H.
	...
	pose proof (lemma_equalanglestransitive _ _ _ _ _ _ _ _ _ CongA_DCE_CBA CongA_CBA_ABC) as CongA_DCE_ABC.
	pose proof (lemma_equalanglessymmetric _ _ _ _ _ _ CongA_DCE_ABC) as CongA_ABC_DCE.
	...
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_D_R_A) as Col_D_R_A.
	...
	pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_H_C_R) as Col_H_C_R.
	...
	pose proof (lemma_equalanglestransitive _ _ _ _ _ _ _ _ _ CongA_CAB_BAC CongA_BAC_ACR) as CongA_CAB_ACR.
