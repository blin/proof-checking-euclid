...
Proof.
	...
	pose proof (lemma_extension B A B A neq_B_A neq_B_A) as (F & BetS_B_A_F & Cong_A_F_B_A).
	...
	pose proof (proposition_31short _ _ _ _ BetS_F_A_B nCol_F_B_C) as (E & H & S & BetS_E_C_H & CongA_E_C_A_C_A_B & Par_E_H_F_B & BetS_E_S_B & BetS_C_S_A).
	pose proof (lemma_betweennotequal _ _ _ BetS_B_C_D) as (_ & neq_B_C & _).
	pose proof (lemma_inequalitysymmetric _ _ neq_B_C) as neq_C_B.
	pose proof (lemma_extension C B C B neq_C_B neq_C_B) as (G & BetS_C_B_G & Cong_B_G_C_B).
	pose proof (lemma_NCdistinct _ _ _ nCol_A_B_C) as (_ & _ & _ & _ & _ & neq_C_A).
	pose proof (lemma_extension C A C A neq_C_A neq_C_A) as (J & BetS_C_A_J & Cong_A_J_C_A).
	pose proof (lemma_inequalitysymmetric _ _ neq_C_A) as neq_A_C.
	pose proof (lemma_extension A C A C neq_A_C neq_A_C) as (K & BetS_A_C_K & Cong_C_K_A_C).
	pose proof (lemma_extension A B A B neq_A_B neq_A_B) as (M & BetS_A_B_M & Cong_B_M_A_B).
	...
	pose proof (lemma_extension H E C E neq_H_E neq_C_E) as (L & BetS_H_E_L & Cong_E_L_C_E).
	...
	assert (~ Meet A M L H) as n_Meet_A_M_L_H.
	{
		...
		pose proof (lemma_betweennotequal _ _ _ BetS_H_E_L) as (_ & _ & neq_H_L).
	...
	pose proof (proposition_29 _ _ _ _ _ _ _ Par_H_E_M_A BetS_H_C_E BetS_M_B_A BetS_D_C_B OS_H_C_B_A) as (CongA_H_C_B_C_B_A & CongA_D_C_E_C_B_A & SumTwoRT_E_C_B_C_B_A).
	...
	pose proof (lemma_NCorder _ _ _ nCol_A_C_B) as (nCol_C_A_B & _ & _ & _ & _).
