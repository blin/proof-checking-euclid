...
Proof.
	...
	pose proof (by_prop_Cong_flip _ _ _ _ Cong_AD_DC) as (_ & _ & Cong_AD_CD).
	pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_AB_BC) as Cong_BC_AB.
	pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_AD_DC) as Cong_DC_AD.
	pose proof (by_prop_Cong_symmetric _ _ _ _ Cong_CD_DC) as Cong_DC_CD.

	pose proof (by_prop_Cong_flip _ _ _ _ Cong_DC_AD) as (_ & Cong_CD_AD & _).
	...
	assert (~ BetS C D B) as nBetS_C_D_B.
	{
		...
		pose proof (by_prop_Lt_congruence _ _ _ _ _ _ Lt_AB_AD Cong_AD_CD) as Lt_AB_CD.

		pose proof (by_def_Lt _ _ _ _ _ BetS_C_D_B Cong_CD_CD) as Lt_CD_CB.
		pose proof (by_prop_Lt_transitive _ _ _ _ _ _ Lt_AB_CD Lt_CD_CB) as Lt_AB_CB.
		pose proof (by_prop_Lt_congruence _ _ _ _ _ _ Lt_AB_CB Cong_CB_BC) as Lt_AB_BC.
		pose proof (by_prop_Lt_congruence _ _ _ _ _ _ Lt_AB_BC Cong_BC_AB) as Lt_AB_AB.
	...
	assert (~ BetS C B D) as nBetS_C_B_D.
	{
		...
		pose proof (by_prop_Lt_congruence _ _ _ _ _ _ Lt_AD_AB Cong_AB_CB) as Lt_AD_CB.

		pose proof (by_def_Lt _ _ _ _ _ BetS_C_B_D Cong_CB_CB) as Lt_CB_CD.
		pose proof (by_prop_Lt_transitive _ _ _ _ _ _ Lt_AD_CB Lt_CB_CD) as Lt_AD_CD.
		pose proof (by_prop_Lt_congruence _ _ _ _ _ _ Lt_AD_CD Cong_CD_AD) as Lt_AD_AD.
