...
def lemma_angleorderrespectscongruence(e: Hypothesis, stack: list[list[Any]], w: TextIO):
    ...
    w.write(
        f"pose proof (lemma_angleorderrespectscongruence _ _ _ _ _ _ _ _ _ LtA_{A}_{B}_{C}_X_Y_Z CongA_{a}_{b}_{c}_X_Y_Z) as {e.to_var()}.\n"
    )
...
def LtA(e: Conjunction, stack: list[list[Any]], w: TextIO) -> None:
