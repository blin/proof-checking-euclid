...
Require Import ProofCheckingEuclid.lemma_collinear_tarski_parallel.
...
Lemma lemma_parallel_to_tarski_parallel :
	forall A B C D,
	Par A B C D ->
	TarskiPar A B C D.
Proof.
	...
	pose proof (lemma_collinearorder _ _ _ Col_A_B_a) as (Col_B_A_a & Col_B_a_A & Col_a_A_B & Col_A_a_B & Col_a_B_A).
	pose proof (lemma_collinearorder _ _ _ Col_A_B_b) as (Col_B_A_b & Col_B_b_A & Col_b_A_B & Col_A_b_B & Col_b_B_A).
	pose proof (lemma_collinearorder _ _ _ Col_C_D_c) as (Col_D_C_c & Col_D_c_C & Col_c_C_D & Col_C_c_D & Col_c_D_C).
	pose proof (lemma_collinearorder _ _ _ Col_C_D_d) as (Col_D_C_d & Col_D_d_C & Col_d_C_D & Col_C_d_D & Col_d_D_C).


	pose proof (axiom_betweennesssymmetry _ _ _ BetS_a_e_d) as BetS_d_e_a.
	pose proof (lemma_betweennotequal _ _ _ BetS_a_e_d) as (neq_e_d & neq_a_e & neq_a_d).
	pose proof (lemma_betweennotequal _ _ _ BetS_d_e_a) as (neq_e_a & neq_d_e & neq_d_a).

	pose proof (axiom_betweennesssymmetry _ _ _ BetS_c_e_b) as BetS_b_e_c.
	pose proof (lemma_betweennotequal _ _ _ BetS_c_e_b) as (neq_e_b & neq_c_e & neq_c_b).
	pose proof (lemma_betweennotequal _ _ _ BetS_b_e_c) as (neq_e_c & neq_b_e & neq_b_c).
	...
	assert (~ Col a d P) as n_Col_a_d_P.
	{
		...
		pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_e_b_P) as Col_e_b_P.
		...
		assert (~ eq d P) as n_eq_d_P.
		{
			...
			pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_c_b_P) as Col_c_b_P.
		...
		pose proof (lemma_s_col_BetS_A_B_C _ _ _ BetS_P_b_c) as Col_P_b_c.
	...
	assert (~ ~ TarskiPar A B C D) as n_n_TarskiPar_AB_CD.
	{
		...
		assert (~ neq C d) as n_neq_C_d.
		{
			...
			pose proof (lemma_collinear_tarski_parallel _ _ _ _ _ TarskiPar_AB_cd Col_c_d_C neq_C_d) as TarskiPar_AB_Cd.
			pose proof (lemma_tarskiparallelflip _ _ _ _ TarskiPar_AB_Cd) as (_ & TarskiPar_AB_dC & _).
			pose proof (lemma_collinear_tarski_parallel _ _ _ _ _ TarskiPar_AB_dC Col_d_C_D neq_D_C) as TarskiPar_AB_DC.
		...
		pose proof (lemma_collinear_tarski_parallel _ _ _ _ _ TarskiPar_AB_cC Col_c_C_D neq_D_C) as TarskiPar_AB_DC.
		pose proof (lemma_tarskiparallelflip _ _ _ _ TarskiPar_AB_DC) as (_ & TarskiPar_AB_CD & _).
