...
Proof.
	...
	assert (~ Cross A C B D) as n_CR_A_C_B_D.
	{
		...
		pose proof (lemma_s_os _ _ _ _ _ BetS_A_M_C Col_B_D_M nCol_B_D_A) as OS_A_BD_C.
		pose proof (lemma_samenotopposite _ _ _ _ SS_A_C_BD) as n_OS_A_BD_C.

		contradict OS_A_BD_C.
		exact n_OS_A_BD_C.
	}
