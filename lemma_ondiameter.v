...
Proof.
	...
	pose proof (cn_congruencereflexive F N) as Cong_F_N_F_N.
	...
	destruct BetS_D_N_F_or_BetS_F_N_M_or_eq_F_N as [BetS_D_N_F | [ BetS_F_N_M | eq_F_N]].
	{
		...
		pose proof (lemma_s_incirc_within_radius _ _ _ _ _ _ _ CI_K_F_P_Q BetS_F_N_D Cong_F_D_P_Q Cong_F_N_F_N) as InCirc_N_K.

		exact InCirc_N_K.
	}
	{
		(* case BetS_F_N_M *)
		pose proof (lemma_s_incirc_within_radius _ _ _ _ _ _ _ CI_K_F_P_Q BetS_F_N_M Cong_F_M_P_Q Cong_F_N_F_N) as InCirc_N_K.
