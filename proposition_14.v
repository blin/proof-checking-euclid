...
Proof.
	intros A B C D E.
	intros SumSupp_A_B_C_D_B_E.
	intros OnRay_BC_D.
	intros OS_E_DB_A.

	destruct SumSupp_A_B_C_D_B_E as (a & b & e & c & d & Supp_a_b_c_d_e & CongA_ABC_abc & CongA_DBE_dbe).
	...
	pose proof (lemma_NCdistinct _ _ _ nCol_D_B_E) as (neq_D_B & neq_B_E & neq_D_E & neq_B_D & neq_E_B & neq_E_D).
	...
	pose proof (lemma_s_supp _ _ _ _ _ OnRay_BC_D BetS_A_B_T) as Supp_A_B_C_D_T.
	pose proof (lemma_supplements_conga _ _ _ _ _ _ _ _ _ T CongA_abc_ABC Supp_a_b_c_d_e Supp_A_B_C_D_T) as CongA_dbe_DBT.
	...
	pose proof (lemma_NCorder _ _ _ nCol_T_B_C) as (nCol_B_T_C & nCol_B_C_T & nCol_C_T_B & nCol_T_C_B & nCol_C_B_T).
	...
	pose proof (lemma_NCorder _ _ _ nCol_D_B_E) as (nCol_B_D_E & nCol_B_E_D & nCol_E_D_B & nCol_D_E_B & nCol_E_B_D).
	...
	pose proof (proposition_04 B D T B D E Cong_BD_BD Cong_BT_BE CongA_DBT_DBE) as (Cong_DT_DE & _ & _).
	...
	pose proof (lemma_oppositesidesymmetric _ _ _ _ OS_E_DB_A) as OS_A_DB_E.
	destruct OS_A_DB_E as (m & BetS_A_m_E & Col_D_B_m & nCol_D_B_A).
	...
	pose proof (lemma_s_ss _ _ _ _ _ _ _ Col_D_B_B Col_D_B_m BetS_T_B_A BetS_E_m_A nCol_D_B_T nCol_D_B_E) as SS_T_E_DB.
	pose proof (proposition_07 D B T E neq_D_B Cong_TD_ED Cong_TB_EB SS_T_E_DB) as eq_T_E.
	assert (BetS A B E) as BetS_A_B_E by (rewrite <- eq_T_E; exact BetS_A_B_T).

	pose proof (lemma_s_supp _ _ _ _ _ OnRay_BC_D BetS_A_B_E) as Supp_A_B_C_D_E.

	split.

	exact Supp_A_B_C_D_E.
	exact BetS_A_B_E.
Qed.
