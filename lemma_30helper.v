...
Proof.
	...
	pose proof (lemma_crisscross _ _ _ _ Par_A_G_F_H n_CR_A_F_G_H) as CR_A_H_F_G.

	destruct CR_A_H_F_G as (M & BetS_A_M_H & BetS_F_M_G).
	pose proof (lemma_betweennotequal _ _ _ BetS_A_M_H) as (_ & _ & neq_A_H).
	pose proof (lemma_betweennotequal _ _ _ BetS_F_M_G) as (_ & _ & neq_F_G).
	pose proof (axiom_betweennesssymmetry _ _ _ BetS_F_M_G) as BetS_G_M_F.
	...
	pose proof (lemma_NCdistinct _ _ _ nCol_A_E_F) as (neq_A_E & _ & _ & _ & _ & _).
	pose proof (lemma_NCdistinct _ _ _ nCol_A_G_H) as (_ & neq_G_H & _ & _ & _ & _).
