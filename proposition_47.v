...
Proof.
	...
	destruct Parallelogram_B_C_E_D_2 as (Par_B_C_E_D &_ ).
	pose proof (by_prop_Par_to_TarskiPar _ _ _ _ Par_B_C_E_D) as TarskiPar_B_C_E_D.
	assert (TarskiPar_B_C_E_D_2 := TarskiPar_B_C_E_D).
	destruct TarskiPar_B_C_E_D_2 as (_ & neq_E_D & _ & SameSide_E_D_B_C).

	pose proof (by_prop_neq_symmetric _ _ neq_E_D) as neq_D_E.

	pose proof (by_prop_OppositeSide_flip _ _ _ _ OppositeSide_D_C_B_A) as OppositeSide_D_B_C_A.
	pose proof (lemma_planeseparation _ _ _ _ _ SameSide_E_D_B_C OppositeSide_D_B_C_A) as OppositeSide_E_B_C_A.

	pose proof (
		proposition_47B
		_ _ _ _ _ _ _
		Triangle_A_B_C RightTriangle_B_A_C Square_A_B_F_G OppositeSide_G_B_A_C Square_B_C_E_D OppositeSide_D_C_B_A
	) as (
		M & L &
		Parallelogram_B_M_L_D & BetS_B_M_C &
		Parallelogram_M_C_E_L & BetS_D_L_E &
		BetS_L_M_A & RightTriangle_D_L_A &
	...
	pose proof (by_prop_RightTriangle_collinear _ _ _ _ RightTriangle_D_L_A Col_D_L_E neq_E_L) as RightTriangle_E_L_A.

	pose proof (
		proposition_47B
		_ _ _ _ _ _ _
		Triangle_A_C_B RightTriangle_C_A_B Square_A_C_K_H OppositeSide_H_C_A_B Square_C_B_D_E OppositeSide_E_B_C_A
	) as (
		m & l &
		_ & BetS_C_m_B &
		_ & BetS_E_l_D &
		BetS_l_m_A & RightTriangle_E_l_A &
	...
	pose proof (lemma_droppedperpendicularunique _ _ _ _ RightTriangle_E_l_A RightTriangle_E_L_A Col_E_l_L) as eq_l_L.
