...
Proof.
	...
	pose proof (by_prop_nCol_distinct _ _ _ nCol_A_B_C) as (_ & _ & _ & neq_B_A & neq_C_B & neq_C_A).
	...
	pose proof (by_prop_BetS_notequal _ _ _ BetS_B_A_D) as (neq_A_D & _ & neq_B_D).
	...
	pose proof (by_prop_Cong_flip _ _ _ _ Cong_AD_CA) as (_ & _ & Cong_AD_AC).

	pose proof (by_def_Col_from_BetS_A_B_C _ _ _ BetS_B_A_D) as Col_B_A_D.
	pose proof (by_prop_Col_order _ _ _ Col_B_A_D) as (Col_A_B_D & _ & _ & _ & _).
	pose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_B_A_C Col_B_A_D neq_B_D) as nCol_B_D_C.
	pose proof (by_prop_nCol_order _ _ _ nCol_B_D_C) as (_ & _ & _ & nCol_B_C_D & nCol_C_D_B).
	pose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_A_B_C Col_A_B_D neq_A_D) as nCol_A_D_C.
	pose proof (by_prop_nCol_order _ _ _ nCol_A_D_C) as (_ & nCol_D_C_A & _ & nCol_A_C_D & _).

	pose proof (by_prop_nCol_distinct _ _ _ nCol_A_D_C) as (_ & neq_D_C & _ & _ & neq_C_D & _).

	pose proof (by_prop_CongA_reflexive _ _ _ nCol_D_C_A) as CongA_DCA_DCA.
	pose proof (by_prop_CongA_ABCequalsCBA _ _ _ nCol_C_D_B) as CongA_CDB_BDC.
	...
	pose proof (by_prop_CongA_ABCequalsCBA _ _ _ nCol_A_C_D) as CongA_ACD_DCA.
	pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_ADC_ACD CongA_ACD_DCA) as CongA_ADC_DCA.
	...
	pose proof (by_prop_CongA_symmetric _ _ _ _ _ _ CongA_ADC_BDC) as CongA_BDC_ADC.

	pose proof (by_def_LtA _ _ _ _ _ _ _ _ _ BetS_D_A_B OnRay_CD_D OnRay_CB_B CongA_DCA_DCA) as LtA_DCA_DCB.
	pose proof (by_prop_LtA_respects_congruence_smaller _ _ _ _ _ _ _ _ _ LtA_DCA_DCB CongA_ADC_DCA) as LtA_ADC_DCB.
	pose proof (by_prop_LtA_respects_congruence_smaller _ _ _ _ _ _ _ _ _ LtA_ADC_DCB CongA_BDC_ADC) as LtA_BDC_DCB.
	pose proof (by_prop_LtA_respects_congruence_smaller _ _ _ _ _ _ _ _ _ LtA_BDC_DCB CongA_CDB_BDC) as LtA_CDB_DCB.
	pose proof (by_prop_LtA_respects_congruence _ _ _ _ _ _ _ _ _ LtA_CDB_DCB CongA_BCD_DCB) as LtA_CDB_BCD.
