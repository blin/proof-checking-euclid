...
Proof.
	...
	pose proof (lemma_parallelNC _ _ _ _ Par_A_C_B_D) as (nCol_A_C_B & nCol_A_B_D & _ & nCol_A_C_D).

	pose proof (lemma_NCdistinct _ _ _ nCol_A_C_B) as (neq_A_C & neq_C_B & neq_A_B & neq_C_A & neq_B_C & neq_B_A).
	pose proof (lemma_NCorder _ _ _ nCol_A_C_B) as (nCol_C_A_B & nCol_C_B_A & nCol_B_A_C & nCol_A_B_C & nCol_B_C_A).
	...
	pose proof (lemma_NCdistinct _ _ _ nCol_A_C_D) as (_ & neq_C_D & _ & _ & neq_D_C & _).

	destruct Par_C_A_B_D as (_ & _ & _ & _ & _ & _ & _ & _ & _ & _ & _ & _ & _ & n_Meet_C_A_B_D & _ & _).

	pose proof (lemma_parallel_to_tarski_parallel _ _ _ _ Par_B_D_A_C) as TarskiPar_B_D_A_C.
	destruct TarskiPar_B_D_A_C as (_ & _ & _ & SS_A_C_B_D).

	pose proof (lemma_samesidesymmetric _ _ _ _ SS_A_C_B_D) as (SS_C_A_B_D & _ & _).

	pose proof (postulate_Euclid2 A B neq_A_B) as (E & BetS_A_B_E).
	...
	pose proof (lemma_collinearorder _ _ _ Col_A_B_E) as (Col_B_A_E & Col_B_E_A & Col_E_A_B & Col_A_E_B & Col_E_B_A).
	...
	pose proof (lemma_NCorder _ _ _ nCol_A_E_C) as (nCol_E_A_C & nCol_E_C_A & nCol_C_A_E & nCol_A_C_E & nCol_C_E_A).
	...
	}
	{
		...
		pose proof (lemma_s_cross _ _ _ _ _ BetS_A_M_D BetS_B_M_C) as Cross_A_D_B_C.
	...
	}
	{
		...
		pose proof (postulate_Pasch_outer D E F B C BetS_D_B_F BetS_E_F_C nCol_E_C_D) as (M & BetS_D_M_C & BetS_E_B_M).
		...
		pose proof (lemma_s_cross _ _ _ _ _ BetS_A_M_B BetS_C_M_D) as Cross_A_B_C_D.
	...
	}
	{
		...
		pose proof (postulate_Pasch_outer B C F D E BetS_B_D_F BetS_C_F_E nCol_C_E_B) as (J & BetS_B_J_E & BetS_C_D_J).
	...
	}
	{
		...
		destruct Par_A_C_F_D as (_ & _ & _ & _ & _ & _ & _ & _ & _ & _ & _ & _ & _ & n_Meet_A_C_F_D & _ & _).
