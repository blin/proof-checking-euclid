...
Proof.
	...
	pose proof (by_def_n_Col_from_nCol _ _ _ nCol_E_F_A) as n_Col_E_F_A.
	...
	assert (~ Meet A B C D) as n_Meet_A_B_C_D.
	{
		...
		assert (~ BetS A E G) as n_BetS_A_E_G.
		{
			...
			pose proof (lemma_27helper_BetS_A_E_G _ _ _ _ _ _ _ BetS_A_E_B BetS_C_F_D OppositeSide_A_EF_D Col_A_B_G Col_C_D_G nCol_E_F_D BetS_A_E_G) as LtA_FEB_EFC.

			pose proof (by_prop_LtA_respects_congruence _ _ _ _ _ _ _ _ _ LtA_FEB_EFC CongA_FEB_EFC) as LtA_FEB_FEB.
