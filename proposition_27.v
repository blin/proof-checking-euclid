...
Proof.
	...
	pose proof (by_prop_Col_order _ _ _ Col_C_D_F) as (Col_D_C_F & _ & _ & _ & _).
	...
	pose proof (by_prop_CongA_flip _ _ _ _ _ _ CongA_FEB_EFC) as CongA_BEF_CFE.
	...
	pose proof (by_prop_CongA_reflexive _ _ _ nCol_F_E_A) as CongA_FEA_FEA.
	...
	assert (~ Meet A B C D) as n_Meet_A_B_C_D.
	{
		...
		pose proof (by_prop_Col_order _ _ _ Col_C_G_D) as (Col_G_C_D & _ & _ & _ & _).

		pose proof (by_prop_Col_ABC_ABD_BCD _ _ _ _ Col_C_D_G Col_C_D_F neq_C_D) as Col_D_G_F.
		pose proof (by_prop_Col_order _ _ _ Col_D_G_F) as (_ & Col_G_F_D & _ & _ & _).
		...
		assert (~ BetS A E G) as n_BetS_A_E_G.
		{
			...
			pose proof (by_prop_BetS_notequal _ _ _ BetS_A_E_G) as (neq_E_G & _ & neq_A_G).
			pose proof (by_prop_BetS_notequal _ _ _ BetS_G_E_A) as (neq_E_A & neq_G_E & neq_G_A).
			...
			pose proof (by_prop_nCol_distinct _ _ _ nCol_A_G_F) as (_ & neq_G_F & neq_A_F & _ & neq_F_G & neq_F_A).
			pose proof (by_prop_nCol_order _ _ _ nCol_A_G_F) as (nCol_G_A_F & nCol_G_F_A & nCol_F_A_G & nCol_A_F_G & nCol_F_G_A).

			pose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_G_A_F Col_G_A_E neq_G_E) as nCol_G_E_F.
			pose proof (by_prop_nCol_order _ _ _ nCol_G_E_F) as (nCol_E_G_F & nCol_E_F_G & nCol_F_G_E & nCol_G_F_E & nCol_F_E_G).
			...
			pose proof (by_prop_Col_order _ _ _ Col_G_R_C) as (Col_R_G_C & Col_R_C_G & Col_C_G_R & Col_G_C_R & Col_C_R_G).

			pose proof (by_prop_Col_ABC_ABD_ABE_CDE _ _ _ _ _ neq_C_G Col_C_G_R Col_C_G_F Col_C_G_D) as Col_R_F_D.
			pose proof (by_prop_Col_order _ _ _ Col_R_F_D) as (Col_F_R_D & Col_F_D_R & Col_D_R_F & Col_R_D_F & Col_D_F_R).

			pose proof (by_prop_Col_order _ _ _ Col_E_F_R) as (Col_F_E_R & Col_F_R_E & Col_R_E_F & Col_E_R_F & Col_R_F_E).
		...
		assert (~ OnRay E A G) as n_OnRay_EA_G.
		{
			...
			pose proof (by_prop_OnRay_neq_A_C _ _ _ OnRay_EG_A) as neq_E_A.
