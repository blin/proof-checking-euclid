...
Proof.
	...
	assert (~ Meet A B C D) as n_Meet_A_B_C_D.
	{
		...
		assert (~ BetS A E G) as n_BetS_A_E_G.
		{
			...
			epose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_A_E_F Col_A_E_G neq_A_G) as nCol_A_G_F.
			...
			epose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_G_A_F Col_G_A_E neq_G_E) as nCol_G_E_F.
			...
			epose proof (lemma_s_col_ABC_col_ABD_ncol_ACD_eq_AB F R D E Col_F_R_D Col_F_R_E nCol_F_D_E) as eq_F_R.
		...
		assert (~ OnRay E A G) as n_OnRay_E_A_G.
		{
			...
			pose proof (lemma_onray_strict _ _ _ OnRay_E_A_G) as neq_E_G.
			pose proof (lemma_onray_strict _ _ _ OnRay_E_G_A) as neq_E_A.
			pose proof (lemma_inequalitysymmetric _ _ neq_E_G) as neq_G_E.

			epose proof (lemma_s_ncol_ABD_col_ABC_ncol_ACD _ _ _ _ nCol_E_A_F Col_E_A_G neq_E_G) as nCol_E_G_F.
			...
			epose proof (lemma_s_col_ABC_col_ABD_ncol_ACD_eq_AB F P D E Col_F_P_D Col_F_P_E nCol_F_D_E) as eq_F_P.
		...
		}
		{
			...
			epose proof (lemma_s_col_ABC_col_ABD_ncol_ACD_eq_AB F H A E Col_F_H_A Col_F_H_E nCol_F_A_E) as eq_F_H.
		...
		}
		{
			...
			epose proof (lemma_s_col_ABC_col_ABD_ncol_ACD_eq_AB F C A G Col_F_C_A Col_F_C_G nCol_F_A_G) as eq_F_C.
