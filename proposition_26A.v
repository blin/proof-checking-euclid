...
Proof.
	...
	pose proof (by_prop_CongA_symmetric _ _ _ _ _ _ CongA_BCA_EFD) as CongA_EFD_BCA.
	...
	assert (~ Lt D E A B) as n_Lt_DE_AB.
	{
		...
		pose proof (by_prop_Lt_congruence _ _ _ _ _ _ Lt_DE_AB Cong_AB_BA) as Lt_DE_BA.

		destruct Lt_DE_BA as (G & BetS_B_G_A & Cong_BG_DE).

		pose proof (by_prop_BetS_notequal _ _ _ BetS_B_G_A) as (_ & neq_B_G & _).
		...
		pose proof (by_prop_Cong_flip _ _ _ _ Cong_BG_DE) as (_ & _ & Cong_BG_ED).
		...
		pose proof (by_prop_CongA_symmetric _ _ _ _ _ _ CongA_ABC_GBC) as CongA_GBC_ABC.
		pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_GBC_ABC CongA_ABC_DEF) as CongA_GBC_DEF.

		pose proof (proposition_04 _ _ _ _ _ _ Cong_BG_ED Cong_BC_EF CongA_GBC_DEF) as (_ & _ & CongA_BCG_EFD).
		pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_BCG_EFD CongA_EFD_BCA) as CongA_BCG_BCA.
		pose proof (by_prop_CongA_symmetric _ _ _ _ _ _ CongA_BCG_BCA) as CongA_BCA_BCG.
	...
	assert (~ Lt A B D E) as n_Lt_AB_DE.
	{
		...
		pose proof (by_prop_Lt_congruence _ _ _ _ _ _ Lt_AB_DE Cong_DE_ED) as Lt_AB_ED.
		...
		pose proof (by_prop_Cong_flip _ _ _ _ Cong_EG_AB) as (_ & _ & Cong_EG_BA).
		...
		pose proof (by_prop_CongA_symmetric _ _ _ _ _ _ CongA_DEF_GEF) as CongA_GEF_DEF.
		pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_GEF_DEF CongA_DEF_ABC) as CongA_GEF_ABC.

		pose proof (proposition_04 _ _ _ _ _ _ Cong_EG_BA Cong_EF_BC CongA_GEF_ABC) as (_ & _ & CongA_EFG_BCA).
		pose proof (by_prop_CongA_transitive _ _ _ _ _ _ _ _ _ CongA_EFG_BCA CongA_BCA_EFD) as CongA_EFG_EFD.
		pose proof (by_prop_CongA_symmetric _ _ _ _ _ _ CongA_EFG_EFD) as CongA_EFD_EFG.
