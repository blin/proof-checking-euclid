...
Proof.
	...
	pose proof (lemma_congruencesymmetric _ _ _ _ Cong_Cb_AB) as Cong_AB_Cb.
	...
	pose proof (lemma_congruencesymmetric _ _ _ _ Cong_BE_DF) as Cong_DF_BE.
	pose proof (lemma_congruenceflip _ _ _ _ Cong_DF_BE) as (_ & Cong_FD_BE & _).

	pose proof (lemma_extension _ _ _ _ neq_C_b neq_B_E) as (e & BetS_C_b_e & Cong_be_BE).

	pose proof (lemma_congruencesymmetric _ _ _ _ Cong_be_BE) as Cong_BE_be.
	pose proof (cn_sumofparts A _ E C _ e Cong_AB_Cb Cong_BE_be BetS_A_B_E BetS_C_b_e) as Cong_AE_Ce.
	pose proof (lemma_congruencesymmetric _ _ _ _ Cong_AE_Ce) as Cong_Ce_AE.
	pose proof (lemma_congruencetransitive _ _ _ _ _ _ Cong_be_BE Cong_BE_DF) as Cong_be_DF.
	pose proof (lemma_congruencesymmetric _ _ _ _ Cong_be_DF) as Cong_DF_be.
	...
	pose proof (lemma_lessthancongruence_smaller _ _ _ _ _ _ Lt_DF_bF Cong_DF_be) as Lt_be_bF.
	...
	assert (~ eq F e) as n_eq_F_e.
	{
		...
		pose proof (lemma_congruencetransitive _ _ _ _ _ _ Cong_bF_BE Cong_BE_be) as Cong_bF_be.
		pose proof (lemma_lessthancongruence _ _ _ _ _ _ Lt_BE_bF Cong_bF_be) as Lt_BE_be.
		pose proof (lemma_lessthancongruence _ _ _ _ _ _ Lt_BE_bF Cong_bF_BE) as Lt_BE_BE.
